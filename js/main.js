...
$(function() {
    ...
    //Isotope menu
    function initializeMenuItems(menuClass, tagClass, itemClass) {
        if ($(menuClass).length) {
            var $grid = $(menuClass).isotope({
                // options
            ...
            $(tagClass).on('click', 'span', function() {
                $(tagClass + ' span').removeClass('tagsort-active');
    ...
    initializeMenuItems('.menu-items', '.menu-tags', '.menu-item' , '.tagsort-active');
    // Initialize the second menu
    initializeMenuItems('.menu-items2', '.menu-tags2', '.menu-item2' , '.tagsort2-active');
     // Initialize the 3 menu
    initializeMenuItems('.menu-items3', '.menu-tags3', '.menu-item3' , '.tagsort3-active');
